            ...
            <div className='col-md-6' style={{ margin: '0 auto' }}>
                <div className='text-center about-container'>
                    ...
                    <p className='text-white'>
                        ...
                        I always focus on learning new technology. I am Completed My Graduation in the Department of Computer Science and Engineering, Dhaka International University.
                    </p>
                </div>
            </div>
                ...
                <div className='row'>
                    <Zoom>
                        ...
                        <div className='col-md-5' style={{ marginLeft: '50px' }}>
                            ...
                            <p className='text-white'>Session 2018 to 2022</p>
